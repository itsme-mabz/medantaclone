 ...
 */
    ...
    $.Widget.prototype = {
        ...
        _trigger: function(type, event, data) {
            ...
            return !(typeof callback === "function" && callback.apply(this.element[0], [event].concat(data)) === !1 || event.isDefaultPrevented())
        }
    };
    $.each({
        show: "fadeIn",
 ...
 */
    var effectsEffectSlide = $.effects.define("slide", "show", function(options, done) {
        var startClip, startRef, element = $(this), map = {
            ...
            left: ["right", "left"],
            right: ["left", "right"]
        }, mode = options.mode, direction = options.direction || "left", ref = (direction === "up" || direction === "down") ? "top" : "left", positiveMotion = (direction === "up" || direction === "left"), distance = options.distance || element[ref === "top" ? "outerHeight" : "outerWidth"](!0), animation = {};
        $.effects.createPlaceholder(element);
 ...
 */
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _mouseStop: function(event) {
            ...
            if ((this.options.revert === "invalid" && !dropped) || (this.options.revert === "valid" && dropped) || this.options.revert === !0 || (typeof this.options.revert === "function" && this.options.revert.call(this.element, dropped))) {
 ...
 */
    var widgetsSlider = $.widget("ui.slider", $.ui.mouse, {
        ...
        _refreshValue: function() {
            var lastValPercent, valPercent, value, valueMin, valueMax, oRange = this.options.range, o = this.options, that = this, animate = (!this._animateOff) ? o.animate : !1, _set = {};
            if (this._hasMultipleValues()) {
                this.handles.each(function(i) {
        ...
        _contactContainers: function(event) {
            ...
            if (this.containers.length === 1) {
                ...
                if (itemWithLeastDistance) {
                    ...
                    this._rearrange(event, null, this.containers[innermostIndex].element, !0)
                }
                this._trigger("change", event, this._uiHash());
